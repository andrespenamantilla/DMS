...
public class TbCasosEmpresasItems {
    ...
    public String getCe_contacto() {
        return ce_contacto;
    }
    
    public void setCe_contacto(String ce_contacto) {
        this.ce_contacto = ce_contacto;
    }
    
    public String getCe_etapa() {
        return ce_etapa;
    }
    
    public void setCe_etapa(String ce_etapa) {
